...
class Page4(QWizardPage):
    ...
    def exportToCSV(self):
       # declare test vars
        ...
        for file in self.excel_dict.keys():
            
            current_sheets = self.excel_dict[file].keys()
            
            matched_sheets = set(current_sheets).intersection(self.list_of_sheets_to_use)
